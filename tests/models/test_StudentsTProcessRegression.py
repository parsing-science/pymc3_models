...
class StudentsTProcessRegressionSaveAndLoadTestCase(StudentsTProcessRegressionTestCase):
    def test_save_and_load_work_correctly(self):
        ...
        GPR2 = StudentsTProcessRegression()
        GPR2.load(self.test_dir)

        self.assertEqual(self.test_STPR.inference_type, GPR2.inference_type)
        self.assertEqual(self.test_STPR.num_pred, GPR2.num_pred)
        self.assertEqual(self.test_STPR.num_training_samples, GPR2.num_training_samples)
